...
<body>
 ...
 <div id='map'>
 	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/hpncustomer_tracedisplay.action"
		method=post onsubmit="return ckeckForm()">
 	<TABLE cellSpacing=0 cellPadding=2 border=0> 	
											<TBODY>
												<TR>
													<TD>MAC地址：</TD>
													<TD><INPUT class=textbox id="MACCode"
														style="WIDTH: 80px" maxLength=50 name="MACCode"></TD>
													<TD>设置开始时间</TD>	
...
map.on('load', function () {
    ...
    d3.json('http://47.94.129.191:8080/sshcustorm3/hpncustomer_downloadGeoJson2.action', function(err, data) {
        if (err) throw err;
