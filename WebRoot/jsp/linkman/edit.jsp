...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/linkman_editsave.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3"><input type="text" name="custId" style="WIDTH: 180px" value="${linkman.customer.custName}" /></td>
							</tr>
							<TR>
								<td>联系人名称：</td>
								<td>
